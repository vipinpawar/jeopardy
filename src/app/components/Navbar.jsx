...
function Navbar() {
  ...
  const userRole = session?.user?.role || ''; // Assuming role is populated from session
  ...
  const userNavItems = (
    <>
      ...
      <li>
        <Link href="/game/id" className="hover:text-yellow-400 transition-colors duration-300 font-medium">
          Play Game
        </Link>
      </li>
      <li>
        <Link href="/leader" className="hover:text-yellow-400 transition-colors duration-300 font-medium">
          Leader Board
        </Link>
      </li>
  ...
  const adminNavItem = (
    <li>
      <Link href="/admin/dashboard" className="hover:text-yellow-400 transition-colors duration-300 font-medium">
        Admin Panel
      </Link>
    </li>
  );
        ...
        <div className="navbar py-4 flex justify-between items-center text-white">
          ...
          <div className="navbar-start flex items-center">
            ...
            <div className="dropdown lg:hidden">
              ...
              <ul
                tabIndex={0}
                className="menu menu-sm dropdown-content mt-3 z-[1] p-4 shadow bg-blue-900 rounded-box w-52 space-y-2"
              >
          ...
          <div className="navbar-end flex items-center space-x-4">
            ...
            {status !== 'authenticated' && (
              <Link
                href="/auth/signin"
                className="bg-yellow-400 text-black px-4 py-2 rounded-md font-semibold hover:bg-yellow-500 transition duration-300"
              >
                Sign In
              </Link>
            )}
            ...
            {status === 'authenticated' && (
              <button
                ...
                className="bg-red-500 text-white px-4 py-2 rounded-md font-semibold hover:bg-red-600 transition duration-300 flex items-center gap-2"
              >
                <LogOut size={18} />
                Sign Out
              </button>
